...
function getRectangleString(width, height) {
    let str = String.fromCharCode(9484) + String.fromCharCode(9472).repeat(width - 2) + String.fromCharCode(9488) + "\n";
    for (let i = 0; i < height - 2; i++) {
        str = str + String.fromCharCode(9474) + " ".repeat(width - 2) + String.fromCharCode(9474) + "\n";
    }
    str = str + String.fromCharCode(9492) + String.fromCharCode(9472).repeat(width - 2) + String.fromCharCode(9496) + "\n";
    return str;
